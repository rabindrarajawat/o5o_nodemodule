 ...
 */
export declare const getGatewayTokenAddressForOwnerAndGatekeeperNetwork: (owner: PublicKey, gatekeeperNetwork: PublicKey, seed?: Uint8Array) => Promise<PublicKey>;
 ...
 * @param network The network
 */
export declare const getFeatureAccountAddress: (feature: NetworkFeature, network: PublicKey) => Promise<PublicKey>;
/**
