...
BidderMetadataData.SCHEMA = _a$A.struct([
...
_a$z = BidderPotData;
BidderPotData.SCHEMA = _a$z.struct([
...
AuctionDataExtended.SCHEMA = _a$x.struct([
...
_a$w = CancelBidArgs;
CancelBidArgs.SCHEMA = _a$w.struct([
    ['instruction', 'u8'],
...
_a$v = WinnerLimit;
WinnerLimit.SCHEMA = _a$v.struct([
    ['type', 'u8'],
    ['usize', 'u64'],
]);
...
_a$u = PlaceBidArgs;
PlaceBidArgs.SCHEMA = _a$u.struct([
    ['instruction', 'u8'],
    ['amount', 'u64'],
    ['resource', 'pubkeyAsString'],
]);
...
AuctionManagerStateV2.SCHEMA = _a$s.struct([
    ['status', 'u8'],
...
PayoutTicketData.SCHEMA = _a$r.struct([
    ['key', 'u8'],
...
PrizeTrackingTicketData.SCHEMA = _a$q.struct([
    ['key', 'u8'],
...
WhitelistedCreatorData.SCHEMA = _a$p.struct([
    ['key', 'u8'],
...
SafetyDepositBoxData.SCHEMA = _a$n.struct([
    ['key', 'u8'],
    ['vault', 'pubkeyAsString'],
    ['tokenMint', 'pubkeyAsString'],
    ['store', 'pubkeyAsString'],
...
_a$f = EditionData;
EditionData.SCHEMA = _a$f.struct([
    ['key', 'u8'],
...
EditionMarkerData.SCHEMA = _a$e.struct([
    ['key', 'u8'],
    ['ledger', [31]],
]);
...
MasterEditionV1Data.SCHEMA = _a$d.struct([
    ['key', 'u8'],
    ['supply', 'u64'],
...
CreateMasterEditionArgs.SCHEMA = _a$9.struct([
    ['instruction', 'u8'],
    ['maxSupply', { kind: 'option', type: 'u64' }],
]);
...
MintNewEditionFromMasterEditionViaTokenArgs.SCHEMA = _a$8.struct([
    ['instruction', 'u8'],
    ['edition', 'u64'],
]);
...
_a$5 = SetStoreArgs;
SetStoreArgs.SCHEMA = _a$5.struct([
    ['instruction', 'u8'],
    ['public', 'u8'],
]);
...
SetWhitelistedCreatorArgs.SCHEMA = _a$4.struct([
    ['instruction', 'u8'],
    ['activated', 'u8'],
]);
...
InitAuctionManagerV2Args.SCHEMA = _a$2.struct([
    ['instruction', 'u8'],
    ['amountType', 'u8'],
    ['lengthType', 'u8'],
    ['maxRanges', 'u64'],
...
const mintNFT = ({ connection, wallet, uri, maxSupply, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const createMintTx = new CreateMint({ feePayer: wallet.publicKey }, {
    ...
    const recipient = yield splToken.Token.getAssociatedTokenAddress(splToken.ASSOCIATED_TOKEN_PROGRAM_ID, splToken.TOKEN_PROGRAM_ID, mint.publicKey, wallet.publicKey);
    const createAssociatedTokenAccountTx = new CreateAssociatedTokenAccount({ feePayer: wallet.publicKey }, {
        associatedTokenAddress: recipient,
        splTokenMintAddress: mint.publicKey,
    });
    const mintToTx = new MintTo({ feePayer: wallet.publicKey }, {
        mint: mint.publicKey,
        dest: recipient,
        amount: 1,
    });
    const masterEditionTx = new CreateMasterEdition({ feePayer: wallet.publicKey }, {
        ...
        mint: mint.publicKey,
        mintAuthority: wallet.publicKey,
        maxSupply: new BN__default["default"](maxSupply),
    });
...
const getPlaceBidTransactions = ({ accountRentExempt, bidder, auctionTokenMint, vault, auction, auctionExtended, bidderPot, bidderPotToken, bidderMeta, amount, }) => __awaiter(void 0, void 0, void 0, function* () {
...
const redeemBid = ({ connection, wallet, store, auction, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const bidderMeta = yield BidderMetadata.getPDA(auction, bidder);
    const bidRedemption = (yield web3_js.PublicKey.findProgramAddress([Buffer.from(MetaplexProgram.PREFIX), auction.toBuffer(), bidderMeta.toBuffer()], MetaplexProgram.PUBKEY))[0];
...
const getRedeemBidTransactions = ({ accountRentExempt, bidder, tokenMint, store, vault, auction, auctionManager, auctionExtended, bidRedemption, bidderMeta: bidMetadata, safetyDepositTokenStore, safetyDeposit, fractionMint, safetyDepositConfig, transferAuthority, metadata, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const redeemBidTransaction = new RedeemBid({ feePayer: bidder }, {
        store,
        vault,
        auction,
        auctionManager,
